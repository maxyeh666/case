<?php
/* Smarty version 3.1.34-dev-7, created on 2020-03-03 23:13:23
  from 'E:\xampp\htdocs\case\templates\tpl\show.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.34-dev-7',
  'unifunc' => 'content_5e5e741395cd57_46382648',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'fbdcaf6e61a9fb3d4cb127ae494127bf7188a83f' => 
    array (
      0 => 'E:\\xampp\\htdocs\\case\\templates\\tpl\\show.tpl',
      1 => 1583248402,
      2 => 'file',
    ),
  ),
...
function content_5e5e741395cd57_46382648 (Smarty_Internal_Template $_smarty_tpl) {
  ...
  <table class="table table-striped table-bordered table-hover table-sm">
    <thead class="thead-light text-center">
      <tr>
        ...
        <th scope="col">狀態</th>
        <th scope="col">
          <a href="show.php?op=op_form&kind=<?php echo $_smarty_tpl->tpl_vars['kind']->value;?>
...
" width="80px"></td>
          ...
          <td class="align-middle">
            <a href="show.php?op=op_form&kind=<?php echo $_smarty_tpl->tpl_vars['row']->value['kind'];?>
...
>
    function op_delete(kind,sn){
      ...
      if (result.value) {
        document.location.href="show.php?op=op_delete&kind=" + kind + "&sn=" + sn;
      }
      })
    }
  <?php echo '</script'; ?>
...
<?php if ($_smarty_tpl->tpl_vars['op']->value == "op_form") {?>
  <div class="container" style="margin: 100px auto 0px auto;">
    ...
    <form action="show.php" method="post" id="myForm" class="mb-20" enctype="multipart/form-data">
